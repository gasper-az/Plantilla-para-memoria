...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Predicción de quiebra de empresas mediante técnicas de machine learning} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Gaspar Acevedo Zain} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. Ariadna Garmendia (FIUBA)} \\[1cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Lic. Fabricio Lopretto (FIUBA)} \\[1.5cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Buenos Aires, junio de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
