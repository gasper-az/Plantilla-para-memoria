...
\begin{table}[h]
	...
	\begin{tabular}{c l}
		...
		\midrule
        IQR                          & Detección de \textit{outliers} \\
		Imputación por media         & Tratamiento de \textit{outliers} \\
        Imputación por mediana       & Tratamiento de \textit{outliers} \\
        Imputación por moda          & Tratamiento de \textit{outliers} \\
        Imputación por raíz cuadrada & Tratamiento de \textit{outliers} \\
