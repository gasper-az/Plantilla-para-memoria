...
Para validar el correcto funcionamiento de esta API se utilizan herramientas como curl \citep{WEBSITE:curl} y postman \citep{WEBSITE:postman}, las que permiten realizar peticiones web a los distintos \textit{endpoints} disponibles, tanto de manera manual como automática.
